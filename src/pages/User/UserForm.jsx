...
import SocialPractices from "../../assets/data/socialPractices.json";
import GovernancePractices from "../../assets/data/GovernancePractices.json";
import {
  IconButton,
  Box,
  TextField,
...
const UserForm = () => {
  ...
  const steps = [
    ...
    "Social Practices",
    "Governance Practices / Awards and Recognition",
...
>
  ...
  <MenuItem value="Other">Other</MenuItem>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    checked={
                      formData.scope1.refrigerationandAirConditioning === true
                    }
                    onChange={() =>
                      setFormData({
                        ...formData,
                        scope1: {
                          ...formData.scope1,
                          refrigerationandAirConditioning: true,
                        },
                      })
                    }
                  />
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    name="scope1.refrigerationandAirConditioning"
                    checked={
                      formData.scope1.refrigerationandAirConditioning === false
                    }
                    onChange={() =>
                      setFormData({
                        ...formData,
                        scope1: {
                          ...formData.scope1,
                          refrigerationandAirConditioning: false,
                        },
                      })
                    }
                  />
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    checked={
                      formData.scope3.upstreamTransportationandDistribution ===
                      true
                    }
                    onChange={() =>
                      setFormData({
                        ...
                        scope3: {
                          ...formData.scope3,
                          upstreamTransportationandDistribution: true,
                        },
                      })
                    }
                  />
                  ...
                  <Checkbox
                    ...
                    onChange={() =>
                      setFormData({
                        ...
                        scope3: {
                          ...formData.scope3,
                          upstreamTransportationandDistribution: false,
                        },
                      })
                    }
                  />
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    checked={
                      formData.scope3.wasteGeneratedinOperations === true
                    }
                    onChange={() =>
                      setFormData({
                        ...formData,
                        scope3: {
                          ...formData.scope3,
                          wasteGeneratedinOperations: true,
                        },
                      })
                    }
                  />
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    name="scope3.wasteGeneratedinOperations"
                    checked={
                      formData.scope3.wasteGeneratedinOperations === false
                    }
                    onChange={() =>
                      setFormData({
                        ...formData,
                        scope3: {
                          ...formData.scope3,
                          wasteGeneratedinOperations: false,
                        },
                      })
                    }
                  />
                ...
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={() =>
                        handleCheckboxChange("upstreamActivities", option)
                      }
                    />
                  }
                  label={option}
        ...
        {step === 4 && (
          <Box>
            <Typography variant="h6">Step 5: Social Practices</Typography>
            {SocialPractices.map((qstn, index) => (
              <FormControlLabel
                key={index}
                control={
                  <Checkbox
                    name={`socialPractices.${Object.keys(qstn)[0]}`}
                    checked={
                      formData.socialPractices[Object.keys(qstn)[0]] || false
                    }
                    onChange={handleChange}
                  />
                }
                label={Object.values(qstn)[0]}
              />
            ))}
          </Box>
        )}
        ...
        {step === 5 && (
          <Box>
            <Typography variant="h6">
              Step 6: Governance Practices / Awards and Recognition
            </Typography>
            {GovernancePractices.map((qstn, index) => (
              <FormControlLabel
                key={index}
                control={
                  <Checkbox
                    name={`governancePractices.${Object.keys(qstn)[0]}`}
                    checked={
                      formData.governancePractices[Object.keys(qstn)[0]] ||
                      false
                    }
                    onChange={handleChange}
                  />
