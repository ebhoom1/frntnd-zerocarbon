    ...
    >
      ...
      <ResponsiveContainer width="100%" height={260}>
        ...
        >
          ...
          <YAxis />
          <Tooltip />
          <Bar dataKey="emissionSource1" stackId="a" fill={COLORS[0]} />
          <Bar dataKey="emissionSource2" stackId="a" fill={COLORS[1]} />
          <Bar dataKey="emissionSource3" stackId="a" fill={COLORS[2]} />
        </BarChart>
      </ResponsiveContainer>
    </Paper>
  );
